        ...
        val zeebeClientDuration =
            ZeebeClient
                ...
                .use { zeebeClient ->
                    ...
                    val zeebeClientDuration =
                        jobWorkerBuilder.open().use {
                            measureTime {
                                val processInstanceResults =
                                    (1..instancesCount)
                                        .map {
                                            zeebeClient
