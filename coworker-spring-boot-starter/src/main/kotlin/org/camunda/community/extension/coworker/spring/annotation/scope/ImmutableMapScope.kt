...
data class ImmutableMapScope(
    ...
    ): Any = map[name] ?: objectFactory.`object`
    ...
    override fun resolveContextualObject(key: String): Any? = map[key]

    override fun getConversationId(): String = map.toList().joinToString(separator = ", ") { "${it.first}:${it.second}" }
